...
3. `outputDirectory`: Specifies the output directory where the generated documentation will be stored. By default, this field is set to `docs/build` within the project structure. This is the same as the `output` CLI argument.

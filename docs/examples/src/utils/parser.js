...
class Parser {
     ...
     * */
    static getReturnsValues(comment) {
     ...
     * */
    static getThrownErrors(comment) {
        ...
        while ((match = referencesRegex.exec(comment)) !== null) {
            if (match[2]) {
                ...
                if (externalModuleWithSubcategoryConstructMatch) {
                    referencesMatches.push({
                        text: externalModuleWithSubcategoryConstructMatch[0],
                ...
                if (externaModuleWithSubcategoryMatch) {
                    referencesMatches.push({
                        text: externaModuleWithSubcategoryMatch[0],
                ...
                if (externamModuleContructMatch) {
                    referencesMatches.push({
                        text: externamModuleContructMatch[0],
                ...
                if (localModuleConstructMatch) {
                    referencesMatches.push({
                        text: localModuleConstructMatch[0],
